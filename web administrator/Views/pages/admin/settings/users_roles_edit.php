...
<body>
    <div class="page-wrapper" id="pageWrapper">
        ...
        <div class="page-body-wrapper horizontal-menu">
            ...
            <div class="page-body">
                <?php echo view('partials/page-title', array('pagetitle' => 'Home', 'title' => 'Edit Role Pengguna')); ?>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card">
                                <form class="form-horizontal" method="post" action="<?php echo site_url('usersroles/edit'); ?>">
                                    <div class="card-header mb-0 b-t-success border-2 align-items-center d-flex">
                                        <div class=" flex-grow-1">
                                            <h5 class="card-title mb-0">Edit Role Pengguna</h5>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label " for="nama">Roles</label>
                                            <div class="col-md-9">
                                                <input type="text" id="roles" name="roles" class="form-control" placeholder="Roles" value="<?= $mdata->roles ?>" required>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <textarea type="description" id="description" name="description" class="form-control" placeholder="Description" required><?= $mdata->description ?></textarea>
