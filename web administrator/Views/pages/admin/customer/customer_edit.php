...
<body>
	<div class="page-wrapper" id="pageWrapper">
		...
		<div class="page-body-wrapper horizontal-menu">
			...
			<div class="page-body">
				<?php echo view('partials/page-title', array('pagetitle' => 'Home', 'title' => 'Edit Customer')); ?>
								...
								<form class="form-horizontal" method="post" action="<?php echo site_url('customer/edit'); ?>" enctype="multipart/form-data">
									...
									<div class="card-body">
										...
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<input type="text" id="email" name="nama_customer" class="form-control" placeholder="Nama Customer" value="<?= old('nama_customer', $mdata->nama_customer) ?>" required>
