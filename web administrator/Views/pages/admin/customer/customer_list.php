...
<body>
    <div class="page-wrapper" id="pageWrapper">
        ...
        <div class="page-body-wrapper horizontal-menu">
            ...
            <div class="page-body">
                <?php echo view('partials/page-title', array('pagetitle' => 'Home', 'title' => 'Data Customer')); ?>
                            ...
                            <div class="card">
                                <div class="card-header mb-0 b-t-success border-2 align-items-center d-flex">
                                    ...
                                    <div class="flex-shrink-0">
                                        <a href="<?= base_url('customer/create'); ?>" class="btn btn-primary"><i class="ri-add-line align-middle"></i> Tambah Data</a>
                                    </div>
                                </div>
                                <div class="card-body">
    ...
    <script type="text/javascript">
        ...
        function showData() {
            ...
            $('#datatable').DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo base_url('customer/load') ?>",
                    "type": "POST",
                },
                "columnDefs": [{
                        "orderable": false,
