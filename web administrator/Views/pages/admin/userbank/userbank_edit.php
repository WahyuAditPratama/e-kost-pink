...
<body>
	<div class="page-wrapper" id="pageWrapper">
		...
		<div class="page-body-wrapper horizontal-menu">
			...
			<div class="page-body">
				<?php echo view('partials/page-title', array('pagetitle' => 'Home', 'title' => 'Edit room')); ?>
				<div class="container-fluid">
					<div class="row">

						<div class="col-lg-8">
							<div class="card">
								<form class="form-horizontal" method="post" action="<?php echo site_url('room/edit'); ?>" enctype="multipart/form-data">
									...
									<div class="card-body">
										...
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<input type="text" id="nama_room" name="nama_room" class="form-control" placeholder="Nama" value="<?= old('nama_room', $mdata->nama_room) ?>" required>
										...
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<textarea type="fitur" id="fitur" name="fitur" class="form-control" placeholder="Fitur" required><?= old('fitur', $mdata->fitur) ?></textarea>
										...
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<textarea type="deskripsi" id="deskripsi" name="deskripsi" class="form-control" placeholder="Deskripsi" required><?= old('deskripsi', $mdata->deskripsi) ?></textarea>
										...
										<div class="form-group row mb-3">
											...
											<div class="col-md-9">
												<input type="number" id="harga_bulanan" name="harga_bulanan" class="form-control" placeholder="harga_bulanan" value="<?= old('harga_bulanan', $mdata->harga_bulanan) ?>" required>
