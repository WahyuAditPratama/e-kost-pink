...
class BookingModel extends Model
{
	...
	protected $request;
	var $column_order = array('a.id', 'a.invoice', 'a.tanggal', 'a.status', null);
	var $column_search = array('a.invoice', 'a.tanggal', 'a.status');
	...
	private function getDatatablesQuery()
	{
		...
		$this->whereIn('a.status', ['konfirmasi', 'proses']);
