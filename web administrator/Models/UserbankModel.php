...
class UserbankModel extends Model
{
	...
	var $column_order = array('a.id', 'a.nama_user_bank', 'a.fitur', 'a.deskripsi', 'a.harga_bulanan', 'a.status', null);
	var $column_search = array('a.nama_user_bank', 'a.fitur', 'a.deskripsi', 'a.harga_bulanan', 'a.status');
	var $order = array('a.id' => 'asc', 'a.nama_user_bank' => 'asc');
