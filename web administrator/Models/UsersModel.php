...
class UsersModel extends Model
{
	...
	var $column_order = array('a.id', 'a.foto', 'a.rolesid', 'a.username', 'a.nama', 'a.email', 'a.status', null);
	var $column_search = array('a.rolesid', 'a.username', 'a.nama', 'a.email', 'a.status');
	var $order = array('a.id' => 'asc', 'a.username' => 'asc');
	...
	private function getDatatablesQuery()
	{
		...
		$this->select('a.*');
		$this->from('users a', true);
		$this->where('a.username!=', '' . $this->auth->username . '');
