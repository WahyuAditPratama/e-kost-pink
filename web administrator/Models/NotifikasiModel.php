...
class NotifikasiModel extends Model
{
	...
	protected $request;
	var $column_order = array('a.id', 'a.judul', 'a.penerima', 'a.pengirim', 'a.parameter', 'a.dibaca', null);
	var $column_search = array('a.judul', 'a.penerima', 'a.pengirim', 'a.parameter', 'a.dibaca');
	var $order = array('a.id' => 'asc', 'a.judul' => 'asc');
