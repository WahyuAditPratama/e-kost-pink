...
import com.app.kostpink.databinding.FragmentLunasBinding;
...
public class LunasFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentLunasBinding.inflate(inflater, container, false);
    ...
    void getData() {
        ...
        Call<FetchTagihanResponse> call = ApiClient.getInstance().getApi().fetchTagihanLunas(id_customer);
