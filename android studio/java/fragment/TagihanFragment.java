...
import com.app.kostpink.databinding.FragmentTagihanBinding;
...
public class TagihanFragment extends Fragment {
    ...
    FragmentTagihanBinding binding;
    ...
    void getData() {
        ...
        Call<FetchTagihanResponse> call = ApiClient.getInstance().getApi().fetchTagihan(id_customer);
