...
import com.app.kostpink.activity.AdmDetailTagihanActivity;
import com.app.kostpink.activity.DetailTagihanActivity;
import com.app.kostpink.model.Tagihan;

import java.util.List;

public class AdmTagihanAdapter extends RecyclerView.Adapter<AdmTagihanAdapter.ViewHolder> {

    List<Tagihan> tagihanList;
    Context context;

    public AdmTagihanAdapter(Context context, List<Tagihan> tagihanList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_adm_tagihan, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            Intent i = new Intent(context, AdmDetailTagihanActivity.class);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView tv_item1, tv_item3, tv_item4, tv_status;
