...
public class AdmBookingAdapter extends RecyclerView.Adapter<AdmBookingAdapter.ViewHolder> {

    List<Booking> BookingList;
    Context context;

    public AdmBookingAdapter(Context context, List<Booking> BookingList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(), AdmDetailBookingActivity.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_item1, tv_item2, tv_item3, tv_status;
